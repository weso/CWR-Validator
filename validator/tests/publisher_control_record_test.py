...
class PublisherControlValidationTest(unittest.TestCase):
    def setUp(self):
        self._validator = Validator()

    def test_null(self):
        self.assertFalse(self._validator.validate_publisher_control_record(None))

    def test_empty(self):
        self.assertFalse(self._validator.validate_publisher_control_record(''))

    def test_record(self):
        self.assertTrue(self._validator.validate_publisher_control_record(
