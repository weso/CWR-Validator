...
class NRAgreementPartyNameRecord(Record):
    ...
    IPA_NAME = regex.get_non_roman_regex(160)
    IPA_WRITER_NAME = regex.get_non_roman_regex(160)
    ...
    def _build_record(self, record):
        ...
        self._ipa_id = self.get_value(19, 9)
        self._ipa_name = self.get_value(29, 160)
        self._writer_name = self.get_value(187, 160)
